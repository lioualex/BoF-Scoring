...
BEGIN
  IF p_division = 'adv' THEN
    game_dates := ARRAY[
      '2026-06-17'::DATE, '2026-06-24'::DATE, '2026-07-08'::DATE,
      '2026-07-15'::DATE, '2026-07-22'::DATE, '2026-07-29'::DATE,
      '2026-08-05'::DATE
    ];
  ELSE
    game_dates := ARRAY[
      '2026-06-18'::DATE, '2026-06-25'::DATE, '2026-07-09'::DATE,
      '2026-07-16'::DATE, '2026-07-23'::DATE, '2026-07-30'::DATE,
      '2026-08-06'::DATE
    ];
  END IF;
